...
🙋🏻‍♂<b>😎 𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖻𝗒 @MazhavilMovieTG</b>"""     
 


    ABOUT_TXT = """<b>⎊ 𝖬𝗒 𝖭𝖺𝗆𝖾: {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=url='https://t.me/George_sirr>Gᴇᴏʀɢᴇ Sɪʀ</a>
✯ 𝚄𝙿𝙳𝙰𝚃𝙴𝚂: <a href=https://t.me/Mazhavil_bots>MᴀᴢʜᴀᴠɪʟMᴏᴠɪᴇꜱ</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: Vᴘꜱ
...
Cʜᴏᴏꜱᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ᴏɴᴇ ʙᴇʟᴏᴡ</i></b>"""
    ...
    I_CUDNT = """<b>❝ 𝖧𝖾𝗒 Bᴜᴅᴅʏ താഴെ ഉള്ള കാര്യങ്ങൾ ശ്രദ്ധിക്കുക ❞
...
‼ 𝖱𝖾𝗉𝗈𝗋𝗍 𝗍𝗈 𝖺𝖽𝗆𝗂𝗇 ▶ @MazhavilAdminBot</b>"""
    ...
    I_CUD_NT = """<b>❝ 𝖧𝖾𝗒 Bᴜᴅᴅʏ താഴെ ഉള്ള കാര്യങ്ങൾ ശ്രദ്ധിക്കുക ❞
...
‼ 𝖱𝖾𝗉𝗈𝗋𝗍 𝗍𝗈 𝖺𝖽𝗆𝗂𝗇 ▶ @MazhavilAdminBot</b>"""
    ...
    MVE_NT_FND = """<b>❝ 𝖧𝖾𝗒 Bᴜᴅᴅʏ താഴെ ഉള്ള കാര്യങ്ങൾ ശ്രദ്ധിക്കുക ❞
