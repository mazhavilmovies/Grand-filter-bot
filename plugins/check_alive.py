...
async def help(_, message):
    await message.reply_text("❗️𝗛𝗼𝘄 𝘁𝗼 𝗦𝗲𝗮𝗿𝗰𝗵 𝗠𝗼𝘃𝗶𝗲𝘀 𝗛𝗲𝗿𝗲❓\n\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n𝟭. 𝗝𝘂𝘀𝘁 𝗦𝗲𝗻𝗱 𝗠𝗼𝘃𝗶𝗲 𝗡𝗮𝗺𝗲 𝗮𝗻𝗱 𝗠𝗼𝘃𝗶𝗲 𝗥𝗲𝗹𝗲𝗮𝘀𝗲𝗱 𝗬𝗲𝗮𝗿 𝗖𝗼𝗿𝗿𝗲𝗰𝘁𝗹𝘆.\n\n<blockquote>(𝗖𝗵𝗲𝗰𝗸 𝗚𝗼𝗼𝗴𝗹𝗲 𝗳𝗼𝗿 𝗖𝗼𝗿𝗿𝗲𝗰𝘁 𝗠𝗼𝘃𝗶𝗲 𝗦𝗽𝗲𝗹𝗹𝗶𝗻𝗴 𝗮𝗻𝗱 𝗠𝗼𝘃𝗶𝗲 𝗥𝗲𝗹𝗲𝗮𝘀𝗲𝗱 𝗬𝗲𝗮𝗿)\n\n<blockquote></b>𝗘𝘅𝗮𝗺𝗽𝗹𝗲𝘀:\n\n-𝗢𝗽𝗽𝗮𝗺 𝟮𝟬𝟭𝟲\n\n𝗕𝗮𝗮𝗵𝘂𝗯𝗮𝗹𝗶 𝟮𝟬𝟭𝟱 𝟭𝟬𝟴𝟬𝗽\n\n<blockquote>(𝗙𝗼𝗿 𝗚𝗲𝘁𝘁𝗶𝗻𝗴 𝗼𝗻𝗹𝘆 𝟭𝟬𝟴𝟬𝗽 𝗤𝘂𝗮𝗹𝗶𝘁𝘆 𝗙𝗶𝗹𝗲𝘀)<blockquote></b>\n\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n𝗕𝗮𝗮𝗵𝘂𝗯𝗮𝗹𝗶 𝟮𝟬𝟭𝟱 𝗠𝗮𝗹𝗮𝘆𝗮𝗹𝗮𝗺\n\n𝗕𝗮𝗮𝗵𝘂𝗯𝗮𝗹𝗶 𝟮𝟬𝟭𝟱 𝗧𝗮𝗺𝗶𝗹\n\n<blockquote>\n\n(𝗙𝗼𝗿 𝗗𝘂𝗯𝗯𝗲𝗱 𝗠𝗼𝘃𝗶𝗲 𝗙𝗶𝗹𝗲𝘀)<blockquote></b>\n\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n❗️𝗢𝗻 𝗔𝗻𝗱𝗿𝗼𝗶𝗱, 𝗕𝗲𝘁𝘁𝗲𝗿 𝗨𝘀𝗲 𝗩𝗟𝗖 𝗠𝗲𝗱𝗶𝗮 𝗣𝗹𝗮𝘆𝗲𝗿 𝗙𝗼𝗿 𝗪𝗮𝘁𝗰𝗵 𝗠𝗼𝘃𝗶𝗲'𝘀.\n\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
