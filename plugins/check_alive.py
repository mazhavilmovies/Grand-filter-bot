...
async def help(_, message):
    await message.reply_text("<b>❗️𝗛𝗼𝘄 𝘁𝗼 𝗦𝗲𝗮𝗿𝗰𝗵 𝗠𝗼𝘃𝗶𝗲𝘀 𝗛𝗲𝗿𝗲❓</b>▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬<b> <b>1.</b>  𝗝𝘂𝘀𝘁 𝘀𝗲𝗻𝗱 𝘁𝗵𝗲 <b>𝗠𝗼𝘃𝗶𝗲 𝗡𝗮𝗺𝗲</b>𝗮𝗻𝗱 <b>𝗠𝗼𝘃𝗶𝗲 𝗥𝗲𝗹𝗲𝗮𝘀𝗲𝗱 𝗬𝗲𝗮𝗿</b> 𝗰𝗼𝗿𝗿𝗲𝗰𝘁𝗹𝘆. <blockquote>(𝗖𝗵𝗲𝗰𝗸 𝗚𝗼𝗼𝗴𝗹𝗲 𝗳𝗼𝗿 𝗰𝗼𝗿𝗿𝗲𝗰𝘁 𝗺𝗼𝘃𝗶𝗲 𝘀𝗽𝗲𝗹𝗹𝗶𝗻𝗴 𝗮𝗻𝗱 𝗿𝗲𝗹𝗲𝗮𝘀𝗲 𝘆𝗲𝗮𝗿)</blockquote><b>𝗘𝘅𝗮𝗺𝗽𝗹𝗲𝘀:</b>-\n• 𝗢𝗽𝗽𝗮𝗺 𝟮𝟬𝟭𝟲\n• 𝗕𝗮𝗮𝗵𝘂𝗯𝗮𝗹𝗶 𝟮𝟬𝟭𝟱 𝟭𝟬𝟴𝟬𝗽 <blockquote>(𝗙𝗼𝗿 𝗴𝗲𝘁𝘁𝗶𝗻𝗴 𝗼𝗻𝗹𝘆 𝟭𝟬𝟴𝟬𝗽 𝗾𝘂𝗮𝗹𝗶𝘁𝘆 𝗳𝗶𝗹𝗲𝘀)</blockquote> ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ <b>𝗗𝘂𝗯𝗯𝗲𝗱 𝗠𝗼𝘃𝗶𝗲𝘀:</b>-\n• 𝗕𝗮𝗮𝗵𝘂𝗯𝗮𝗹𝗶 𝟮𝟬𝟭𝟱 𝗠𝗮𝗹𝗮𝘆𝗮𝗹𝗮𝗺\n• 𝗕𝗮𝗮𝗵𝘂𝗯𝗮𝗹𝗶 𝟮𝟬𝟭𝟱 𝗧𝗮𝗺𝗶𝗹 <blockquote>(𝗙𝗼𝗿 𝗱𝘂𝗯𝗯𝗲𝗱 𝗺𝗼𝘃𝗶𝗲 𝗳𝗶𝗹𝗲𝘀)</blockquote>▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬❗️ 𝗢𝗻 𝗔𝗻𝗱𝗿𝗼𝗶𝗱, 𝗯𝗲𝘁𝘁𝗲𝗿 𝘂𝘀𝗲 <b>𝗩𝗟𝗖 𝗠𝗲𝗱𝗶𝗮 𝗣𝗹𝗮𝘆𝗲𝗿</b> 𝘁𝗼 𝘄𝗮𝘁𝗰𝗵 𝗺𝗼𝘃𝗶𝗲𝘀.  ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
