...
async def check_alive(_, message):
    await message.reply_text("Yᴏᴜ ᴀʀᴇ ᴠᴇʀʏ ʟᴜᴄᴋʏ 🤞 I ᴀᴍ ᴀʟɪᴠᴇ ❤️ Pʀᴇꜱꜱ /Start ᴛᴏ ᴜꜱᴇ ᴍᴇ\n\n𝖧𝗂𝗍 /Help 𝖥𝗈𝗋 𝖧𝖾𝗅𝗉 ⚡")

@Client.on_message(filters.command("help", CMD))
async def help(_, message):
    await message.reply_text("<b>❗️How to Search Movies Here❓</b>▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬<b>1.</b> Just send the <b>Movie Name</b> and <b>Movie Released Year</b> correctly. <blockquote>(Check Google for correct movie spelling and release year)</blockquote><b>Examples:</b>-\n• Oppam 2016\n• Baahubali 2015 1080p <blockquote>(For getting only 1080p quality files)</blockquote> ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ <b>Dubbed Movies:</b>-\n• Baahubali 2015 Malayalam\n• Baahubali 2015 Tamil <blockquote>(For dubbed movie files)</blockquote>▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬❗️ On Android, better use <b>VLC Media Player</b> to watch movies.  ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
...
async def tutorial(_, message):
    await message.reply_text("𝖢𝗁𝖾𝖼𝗄𝗈𝗎𝗍 @grandcinemas 𝖥𝗈𝗋 𝖳𝗎𝗍𝗈𝗋𝗂𝖺𝗅𝗌 😎")
